...
public enum SystemOption {
    ...
    TOKEN_DAYS("30"),
    USER_IMAGE("http://biuimage.meetme.cool/upload/tou.png"),
    REGISTER_NOTICE("欢迎加入BIU笔友，记录生活，畅聊感悟，分享密语心情，搜寻您的云中笔友吧！"),
    REGISTER_NOTICE_BANNER("http://biuimage.meetme.cool/banner_welcome.jpg"),
    REGISTER_NOTICE_IMAGE("http://biuimage.meetme.cool/welcome.jpg"),
    REGISTER_NOTICE_PLAT_BANNER("http://biuimage.meetme.cool/banner_notice.jpg"),
    REGISTER_NOTICE_PLAT_IMAGE("http://biuimage.meetme.cool/noticenew.jpg"),

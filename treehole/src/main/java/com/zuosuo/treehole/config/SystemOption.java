...
public enum SystemOption {
    ...
    TOKEN_DAYS("30"),
    USER_IMAGE("http://biuimage.zuosuo.net/upload/tou.png"),
    REGISTER_NOTICE("欢迎加入BIU笔友，记录生活，畅聊感悟，分享密语心情，搜寻您的云中笔友吧！"),
    REGISTER_NOTICE_BANNER("http://biuimage.zuosuo.net/banner_welcome.jpg"),
    REGISTER_NOTICE_IMAGE("http://biuimage.zuosuo.net/welcome.jpg"),
    REGISTER_NOTICE_PLAT_BANNER("http://biuimage.zuosuo.net/banner_notice.jpg"),
    REGISTER_NOTICE_PLAT_IMAGE("http://biuimage.zuosuo.net/noticenew.jpg"),

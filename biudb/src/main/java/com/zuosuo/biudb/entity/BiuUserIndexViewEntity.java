...
@Alias("BiuUserIndexViewEntity")
public class BiuUserIndexViewEntity extends BaseEntity {
    ...
    public int getSelfCommunicate() {
        return selfCommunicate;
    }

    public void setSelfCommunicate(int selfCommunicate) {
        this.selfCommunicate = selfCommunicate;
    }

    public int getSearchCommunicate() {
        return searchCommunicate;
    }

    public void setSearchCommunicate(int searchCommunicate) {
